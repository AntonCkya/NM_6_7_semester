...
func DiffEuler(system []func(x, y, z float64) float64, yKey, zKey []float64, xl, xr, h float64) ([]float64, []float64) {
	var x, y, z []float64
	x = append(x, xl)
	y = append(y, yKey[1])
	z = append(z, zKey[1])
...
func DiffAdams(system []func(x, y, z float64) float64, yKey, zKey []float64, xl, xr, h float64) ([]float64, []float64) {
